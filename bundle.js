...
var id = "!!../../../css-loader/dist/cjs.js!./light.css";
var update = api(id, content, options);
...
class Provider {
  ...
  addPoint(point) {
    ...
    const fakeNewPoint = _models_point__WEBPACK_IMPORTED_MODULE_0__["default"].parsePoint(Object.assign({}, point.toRAW()));
  ...
  updatePoint(id, point) {
    ...
    const fakeUpdatedPoint = _models_point__WEBPACK_IMPORTED_MODULE_0__["default"].parsePoint(Object.assign({}, point.toRAW(), {id}));
...
/***/ "./src/components/abstract-card.js":
/*!*****************************************!*\
  !*** ./src/components/abstract-card.js ***!
  \*****************************************/
/*! exports provided: getImageHtml, getAmenityHtml, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getImageHtml", function() { return getImageHtml; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getAmenityHtml", function() { return getAmenityHtml; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return AbstractCard; });
...
class AbstractCard extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  changeEventPlaceholder(type) {
    this._eventLabel.textContent = _const__WEBPACK_IMPORTED_MODULE_1__["actionByType"].get(type);
  }
  ...
  hideOffersSection() {
    this._offersSection.classList.add(_const__WEBPACK_IMPORTED_MODULE_1__["HIDDEN_CLASS"]);
  }
  ...
  showOffersSection() {
    if (!this._offersSection) {
      ...
      this._offersBlock.innerHTML = Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["createItems"])(this._offersModel.getOffersByType(this._pointData.type), getAmenityHtml);
      this._offersSection.append(this._offersBlock);
    }

    this._offersSection.classList.remove(_const__WEBPACK_IMPORTED_MODULE_1__["HIDDEN_CLASS"]);
  }
  ...
  changeAmenities(type) {
    if (this._offersModel.getOffersByType(type).length <= 0) {
      ...
      this._offersBlock.innerHTML = Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["createItems"])(this._offersModel.getOffersByType(type), getAmenityHtml);
    }
  }
  ...
  changePictures() {
    this._eventDetailsBlock.querySelector(`.event__photos-tape`).innerHTML = Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["createItems"])(this._destinationsModel.getPicturesByCity(this._getCurrentCityValue()), getImageHtml);
  }
...
/* harmony import */ var _abstract_card__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./abstract-card */ "./src/components/abstract-card.js");
      ...
      <header class="event__header">
        ...
        <div class="event__field-group  event__field-group--destination">
          ...
          <select class="event__input event__input--destination" id="destination-list-1" name="event-destination" required>
            ...
            ${Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["createItems"])(destinations, getDestinationHtml)}
          </select>
        </div>
...
class CardAdd extends _abstract_card__WEBPACK_IMPORTED_MODULE_3__["default"] {
  ...
  showEventDetailsBlock() {
    this._eventDetailsBlock.classList.remove(_const__WEBPACK_IMPORTED_MODULE_2__["HIDDEN_CLASS"]);
  }

  hideEventDetailsBlock() {
    this._eventDetailsBlock.classList.add(_const__WEBPACK_IMPORTED_MODULE_2__["HIDDEN_CLASS"]);
  }
  ...
  _applyFlatpickr() {
    ...
    this._flatpickrStartDate = flatpickr__WEBPACK_IMPORTED_MODULE_0___default()(this._startDate, {
      altInput: true,
      defaultDate: now,
      format: `d/m/Y H:i`,
      altFormat: `d/m/Y H:i`,
    ...
    this._flatpickrEndDate = flatpickr__WEBPACK_IMPORTED_MODULE_0___default()(this._endDate, {
      altInput: true,
      defaultDate: now,
      format: `d/m/Y H:i`,
      altFormat: `d/m/Y H:i`,
...
/* harmony import */ var _abstract_card__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-card */ "./src/components/abstract-card.js");
/* harmony import */ var _utils_render__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/render */ "./src/utils/render.js");
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../const */ "./src/const.js");
...
const createEditCardTemplate = (cardData, destinations, offersModel) => {
  ...
  const prefixForActivity = _const__WEBPACK_IMPORTED_MODULE_2__["actionByType"].get(type);
    ...
    <form class="event event--edit" action="#" method="post">
      ...
      `<section class="event__section  event__section--offers">
          ...
          <div class="event__available-offers">
            ${Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["createItems"])(offersModel.getOffersByType(type), _abstract_card__WEBPACK_IMPORTED_MODULE_0__["getAmenityHtml"])}
          </div>
        </section>` : ``}
        <section class="event__section  event__section--destination">
          <h3 class="event__section-title  event__section-title--destination">Destination</h3>
          ...
          <div class="event__photos-container">
            <div class="event__photos-tape">
              ${Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["createItems"])(photos, _abstract_card__WEBPACK_IMPORTED_MODULE_0__["getImageHtml"])}
            </div>
          </div>
        </section>
      </section>
...
class CardEdit extends _abstract_card__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _applyFlatpickr() {
    ...
    this._flatpickrStartDate = flatpickr__WEBPACK_IMPORTED_MODULE_3___default()(this._startDate, {
      altInput: true,
    ...
    this._flatpickrEndDate = flatpickr__WEBPACK_IMPORTED_MODULE_3___default()(this._endDate, {
      altInput: true,
...
const createCardTemplate = (cardData) => {
  ...
  const prefixForActivity = _const__WEBPACK_IMPORTED_MODULE_1__["actionByType"].get(type);

  const startDatetime = moment__WEBPACK_IMPORTED_MODULE_0___default()(start).format(`YYYY-MM-DDThh:mm:ss`);
  const endDatetime = moment__WEBPACK_IMPORTED_MODULE_0___default()(end).format(`YYYY-MM-DDThh:mm:ss`);
  ...
  const duration = Object(_utils_format__WEBPACK_IMPORTED_MODULE_4__["formatDuration"])(end.getTime() - start.getTime());
    ...
    <li class="trip-events__item">
      <div class="event">
        ...
        <ul class="event__selected-offers">
           ${amenities.length > 0 ? Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["createItems"])(amenities, getOfferHtml) : ``}
        </ul>
...
class Card extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_3__["default"] {
...
const createFilterTemplate = (filters) => {
  return (`
    <form class="trip-filters" action="#" method="get">
      ${Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["createItems"])(filters, getFilterHtml)}
...
const createMenuTemplate = () => {
  return (`
    <nav class="trip-controls__trip-tabs  trip-tabs">
      ${Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["createItems"])(MENU_NAMES, getMenuHtml)}
    </nav>
  `);
};
...
const getPointsBlockHtml = (blockData) => {
  const datetimeDate = moment__WEBPACK_IMPORTED_MODULE_0___default()(blockData.date).format(`YYYY-MM-DD`);
  const date = moment__WEBPACK_IMPORTED_MODULE_0___default()(blockData.date).format(`MMM DD`);
...
const createPointsTemplate = (blocksData) => {
  return (`
    <ul class="trip-days">
      ${Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["createItems"])(blocksData, getPointsBlockHtml)}
    </ul>
  `);
};

class Points extends _abstract_component__WEBPACK_IMPORTED_MODULE_1__["default"] {
  ...
  getContainerByDate(date) {
    ...
    for (let i = 0; i < timeElements.length; i++) {
      if (timeElements[i].textContent === moment__WEBPACK_IMPORTED_MODULE_0___default()(date).format(`MMM DD`)) {
  ...
  rerender(blocksData) {
    ...
    this.element.innerHTML = Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["createItems"])(blocksData, getPointsBlockHtml);
  }
...
const getDatesHtml = (routeInfo) => {
  ...
  if (startMonth === endMonth) {
    return (startYear === endYear) ? `${startYear} ${_const__WEBPACK_IMPORTED_MODULE_0__["MONTHS"][startMonth]} ${startDay}&nbsp;&mdash;&nbsp;${endDay}` : `${startYear} ${_const__WEBPACK_IMPORTED_MODULE_0__["MONTHS"][startMonth]} ${startDay}&nbsp;&mdash;&nbsp;${startYear} ${endDay}`;
  }

  return (startYear === endYear) ? `${startYear} ${_const__WEBPACK_IMPORTED_MODULE_0__["MONTHS"][startMonth]} ${startDay}&nbsp;&mdash;&nbsp;${_const__WEBPACK_IMPORTED_MODULE_0__["MONTHS"][endMonth]} ${endDay}` : `${startYear} ${_const__WEBPACK_IMPORTED_MODULE_0__["MONTHS"][startMonth]} ${startDay}&nbsp;&mdash;&nbsp;${startYear} ${_const__WEBPACK_IMPORTED_MODULE_0__["MONTHS"][endMonth]} ${endDay}`;
};
...
class Route extends _abstract_component__WEBPACK_IMPORTED_MODULE_1__["default"] {
...
const getSortHtml = (sortName) => {
  const sortTitle = Object(_utils_format__WEBPACK_IMPORTED_MODULE_0__["capitalizeFirstLetter"])(sortName);
...
const createSortTemplate = (sortItems) => {
  return (`
    <form class="trip-events__trip-sort  trip-sort" action="#" method="get">
      ...
      ${Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["createItems"])(sortItems, getSortHtml)}
...
class Tip extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: Keys, MONTHS, TIP_MESSAGE, actionByType, FilterType, HIDDEN_CLASS, AUTHORIZATION */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TIP_MESSAGE", function() { return TIP_MESSAGE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "actionByType", function() { return actionByType; });
...
const TIP_MESSAGE = `Click New Event to create your first point`;
...
class FilterController {
  ...
  render() {
    ...
    if (oldComponent) {
      ...
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["render"])(this._container, this._filterComponent, _utils_render__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].AFTEREND);
    }
  ...
  _disableFilters() {
    ...
    if (this._pointsModel.getPointsQuantityByFilterType(_const__WEBPACK_IMPORTED_MODULE_2__["FilterType"].FUTURE) === 0) {
      this._filterComponent.makeFilterUnable(_const__WEBPACK_IMPORTED_MODULE_2__["FilterType"].FUTURE);
    }

    if (this._pointsModel.getPointsQuantityByFilterType(_const__WEBPACK_IMPORTED_MODULE_2__["FilterType"].PAST) === 0) {
      this._filterComponent.makeFilterUnable(_const__WEBPACK_IMPORTED_MODULE_2__["FilterType"].PAST);
    }
  }
}
...
class PointController {
  ...
  render(pointData, isDefaultSorting) {
    ...
    this._cardComponent = new _components_card__WEBPACK_IMPORTED_MODULE_0__["default"](this._pointData);
    this._newCurrentType = pointData.type;
    this._editCardComponent = new _components_card_edit__WEBPACK_IMPORTED_MODULE_1__["default"](this._pointData, this._destinationsModel, this._offersModel);
    ...
    const escKeyDownHandler = (evt) => {
      if (evt.key === _const__WEBPACK_IMPORTED_MODULE_3__["Keys"].ESCAPE) {
    ...
    const favButtonClickHandler = lodash_debounce__WEBPACK_IMPORTED_MODULE_5___default()(() => {
      const newPoint = _models_point__WEBPACK_IMPORTED_MODULE_4__["default"].clone(this._pointData);
    ...
    if (isDefaultSorting) {
      ...
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["render"])(this._generalContainer, this._cardComponent);
    }
  }

  replaceEditToCard() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._cardComponent, this._editCardComponent);
    this._mode = Mode.DEFAULT;
  ...
  destroy() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._editCardComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._cardComponent);
  }
  ...
  _replaceCardToEdit() {
    this._onViewChange();
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._editCardComponent, this._cardComponent);
...
/* harmony import */ var _components_card_add__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/card-add */ "./src/components/card-add.js");
/* harmony import */ var _components_points__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/points */ "./src/components/points.js");
/* harmony import */ var _components_route__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/route */ "./src/components/route.js");
...
/* harmony import */ var _components_tip__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/tip */ "./src/components/tip.js");
...
class TripController {
  ...
  constructor(container, header, pointModel, statisticsComponent, destinationsModel, offersModel, api) {
    ...
    this._route = null;
    this._sortComponent = new _components_sort__WEBPACK_IMPORTED_MODULE_1__["default"](SORT_OPTIONS);
    this._currentSortType = _components_sort__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT;
    this._pointsComponent = null;
    this._cards = [];
    this._newPointData = this._changeDefaultNewPointData();
    this._pointControllers = [];
    this._addNewCard = null;
    this._tip = new _components_tip__WEBPACK_IMPORTED_MODULE_6__["default"](_const__WEBPACK_IMPORTED_MODULE_7__["TIP_MESSAGE"]);
  ...
  render() {
    ...
    this._loadingText.classList.add(_const__WEBPACK_IMPORTED_MODULE_7__["HIDDEN_CLASS"]);
    this.enableAddButton();
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, this._tip);
    ...
    if (cardsData.length > 0) {
      ...
      this._pointsComponent = new _components_points__WEBPACK_IMPORTED_MODULE_3__["default"](this._getBlocksData(cardsData));
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, this._pointsComponent);

      this._pointControllers = this._renderPointControllers();
      this._route = new _components_route__WEBPACK_IMPORTED_MODULE_4__["default"](this._cards);
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._tripRoute, this._route, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].AFTERBEGIN);
  ...
  hide() {
    if (this._container) {
      this._container.classList.add(_const__WEBPACK_IMPORTED_MODULE_7__["HIDDEN_CLASS"]);
    }
  }

  show() {
    if (this._container) {
      this._container.classList.remove(_const__WEBPACK_IMPORTED_MODULE_7__["HIDDEN_CLASS"]);
    }
  }
  ...
  _addEventListenerToAddButton() {
    ...
    this._addButton.addEventListener(`click`, () => {
      if (!this._addNewCard) {
        this._addNewCard = new _components_card_add__WEBPACK_IMPORTED_MODULE_2__["default"](this._destinationsModel, this._offersModel);
        Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._sortComponent.element, this._addNewCard, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].AFTEREND);
  ...
  _closeEditCards() {
    for (let i = 0; i < this._pointControllers.length; i++) {
      if (this._pointControllers[i].mode === _point_controller__WEBPACK_IMPORTED_MODULE_5__["Mode"].EDIT) {
  ...
  _parseFormData(formData) {
    return new _models_point__WEBPACK_IMPORTED_MODULE_8__["default"]({
  ...
  _onDataChange(editCardComponent, newPointData, oldPointData) {
    if (newPointData === null) {
      this._api.deletePoint(oldPointData.id)
        ...
        .catch(() => {
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["shake"])(editCardComponent, true);
        });
      ...
      this._api.addPoint(newPointData)
        ...
        .catch(() => {
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["shake"])(this._addNewCard, false);
        });
    } else {
  ...
  _updateHeaderInfo(pointsData) {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["remove"])(this._route);
    this._route = new _components_route__WEBPACK_IMPORTED_MODULE_4__["default"](pointsData);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._tripRoute, this._route, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].AFTERBEGIN);
  ...
  _renderPointControllers() {
    ...
    if (this._currentSortType !== _components_sort__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT) {
      this._pointsComponent.hideDayInfos();
    } else {
    ...
    sortedCards.forEach((card) => {
      const pointController = new _point_controller__WEBPACK_IMPORTED_MODULE_5__["default"](
      ...
      pointController.render(card, this._currentSortType === _components_sort__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT);
...
/* harmony import */ var _models_points__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./models/points */ "./src/models/points.js");
...
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./const */ "./src/const.js");
/* harmony import */ var _models_destinations__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./models/destinations */ "./src/models/destinations.js");
/* harmony import */ var _models_offers__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./models/offers */ "./src/models/offers.js");
/* harmony import */ var _api_store__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./api/store */ "./src/api/store.js");
...
const api = new _api__WEBPACK_IMPORTED_MODULE_6__["default"](END_POINT, _const__WEBPACK_IMPORTED_MODULE_7__["AUTHORIZATION"]);
const store = new _api_store__WEBPACK_IMPORTED_MODULE_10__["default"](STORE_NAME, window.localStorage);
const apiWithProvider = new _api_provider__WEBPACK_IMPORTED_MODULE_11__["default"](api, store);
const menuComponent = new _components_menu__WEBPACK_IMPORTED_MODULE_0__["default"]();
Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["render"])(menuHeader, menuComponent, _utils_render__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].AFTEREND);

const pointsModel = new _models_points__WEBPACK_IMPORTED_MODULE_3__["default"]();
const destinationsModel = new _models_destinations__WEBPACK_IMPORTED_MODULE_8__["default"]();
const offersModel = new _models_offers__WEBPACK_IMPORTED_MODULE_9__["default"]();

const renderBase = () => {
  const statisticsComponent = new _components_statistics__WEBPACK_IMPORTED_MODULE_5__["default"](pointsModel.points);
  Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["render"])(pageBodyContainer, statisticsComponent);
  statisticsComponent.hide();

  const tripController = new _controllers_trip_controller__WEBPACK_IMPORTED_MODULE_2__["default"](tripEvents, tripControl, pointsModel, statisticsComponent, destinationsModel, offersModel, apiWithProvider);
  ...
  const filterController = new _controllers_filter_controller__WEBPACK_IMPORTED_MODULE_4__["default"](filterHeader, pointsModel);
...
class Points {
  ...
  getPointsQuantityByFilterType(filterType) {
    return Object(_utils_filter__WEBPACK_IMPORTED_MODULE_0__["getPointsByFilter"])(this._points, filterType).length;
  }
...
/*!*****************************!*\
  !*** ./src/utils/format.js ***!
  \*****************************/
/*! exports provided: capitalizeFirstLetter, formatDuration */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!*****************************!*\
  !*** ./src/utils/render.js ***!
  \*****************************/
/*! exports provided: RenderPosition, createElement, render, remove, replace, createItems, shake */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const shake = (component, isEditCard) => {
